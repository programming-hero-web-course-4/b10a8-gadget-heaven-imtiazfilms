...
import { GiCrossMark, GiSettingsKnobs } from "react-icons/gi";
import { getCartFromLocal, removeFromCart } from "../Utils/cart";
                    ...
                    {cartItems.map((item) => (
                        ...
                        <div>
                            ...
                            <p
                                ...
                                className="text-red-600 cursor-pointer text-4xl"><GiCrossMark /></p>
                        </div>
                    ))}
                </div>
            )}
